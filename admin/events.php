            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="jobs.php">Eveents</a></li>
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    ...
                                    <a href="add-event.php" class="btn btn-primary"><i class="fas fa-plus"></i> Add Events</a>
                                </div>
                            </div>
                        </div>
                        <?php
                            ...
                            <table id="dataTable" class="table table-bordered" width="100%" cellspacing="0">
                                <thead class="student-thread">
                                    <tr>
                                        ...
                                        <th>Event Title</th>
                                        <th>Organizer</th>
                                        <th>Offered Through(Alumni Email)</th>
                                        <th>Type</th>
                                        <th>Venue</th>
                                        <th>Date and Time</th>
                                        <th>Description</th>
                                        <th>How to join an event?</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="../upload_images/<?= $row["banner_image"] ?>" alt="User Image"></a>
                                                        <a><?= $row["event_title"] ?></a>
                                                    </h2>
                                                </td>
                                                <td><?= $row["organizer"] ?></td>
                                                ...
                                                <td><textarea style="border: none; outline:none;" readonly rows="4" cols="50"> <?= $row["join_event"] ?></textarea> </td>
                                                <td class="text-center">
                                                    
                                                <a href="edit-event.php?event_id=<?= $row['event_id'] ?>" class="btn btn-primary m-1" role="button"><i class="fa fa-eye"></i> View</a>
                                                    <a href="edit-event.php?event_id=<?= $row["event_id"] ?>" role="button" class="btn btn-success m-1"><i class="fa fa-edit"></i> Edit </a>
